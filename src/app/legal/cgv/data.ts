...
const generalTermsOfSalesData: LegalData = {
	...
	sections: [
		...
		{
			title: "Certification du logiciel de caisse",
			subSections: [
				{
					title: "Obligation de certification",
					content: [
						{
							texts: [
								[
		...
		{
			title: "Formation et support client",
			content: [
				{
					texts: [
						[
							"Seconde s’engage à vous fournir une assistance de qualité pour garantir une expérience utilisateur optimale. Notre service client est à votre disposition gratuitement par email et téléphone. Vous trouverez les modalités du support client dans les CGU.",
						],
						[
							"Pour ceux qui souhaitent aller plus loin et tirer pleinement parti des fonctionnalités offertes par Seconde, nous proposons également des formations sur place, conçues pour répondre à vos besoins spécifiques et s’adapter selon la taille et la complexité de votre organisation.",
						],
						[
							"La formation sur place est un service complémentaire payant, disponible sur demande. Les tarifs et les modalités de cette formation seront détaillés dans un devis séparé. Pour organiser une formation sur place, veuillez nous contacter à l’adresse contact@seconde.app.",
						],
					],
				},
			],
