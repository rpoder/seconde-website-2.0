...
const generalTermsOfUseData: LegalData = {
	...
	sections: [
			...
			content: [
				{
					texts: [
						[
							"Seconde met à votre disposition un service de support technique pour vous aider à utiliser le Logiciel et résoudre les éventuels problèmes. Le support est accessible par email à contact@seconde.app ou par téléphone.",
						],
						[
		...
		{
			title: "Certification Logiciel de Caisse",
			content: [
				{
					texts: [
						[
							"Conformément à la législation fiscale en vigueur, Seconde certifie que son Logiciel respecte les exigences d'inaltérabilité, de sécurisation, de conservation et d'archivage des données d'encaissement, comme prévu par l'article L102 B du Livre des Procédures Fiscales.",
						],
						[
...
export default generalTermsOfUseData;
