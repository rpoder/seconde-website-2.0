import { legalNoticeData } from "./data";
import {
	Table,
	TableBody,
	TableCell,
	...
	return (
		<div className="container mx-auto px-48 flex flex-col gap-12 text-justify">
			<div className="w-full">
				<h1 className="text-3xl font-bold">{legalNoticeData.title}</h1>
			</div>
			<div className="w-full flex flex-col gap-8">
				{legalNoticeData.updatedAt}
				<h2 className="text-2xl font-semibold">
					{legalNoticeData.preamble?.title}
				</h2>
				{legalNoticeData.preamble &&
					legalNoticeData.preamble.content.map(
				...
				{legalNoticeData.sections.map((section, index) => (
